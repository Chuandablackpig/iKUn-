<%@ page language="java				<a href="${pageContext.request.contextPath}/index.action"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/ikun_logo.gif"
					alt="iKUN网上商城" /> </a>ontentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
