	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/index.action">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/ikun_logo.gif" alt="我的商城">
			</a>
		</div>
	</div>
	<div class="span9">
		...
		<div class="span24">
			<div class="step step1">
				...
				<div class="bottom">
					...
					<a href="javascript:void(0);" id="submit" class="submit disabled" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">提交订单(已禁用)</a>
				</div>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2025 iKUN网上商城 版权所有</div>
	</div>
</div>
</body></html>